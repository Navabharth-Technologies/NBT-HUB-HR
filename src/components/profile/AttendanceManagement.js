            ...
            <>
              <div style={{ display: 'flex', flexDirection: winWidth < 1024 ? 'column' : 'row', justifyContent: 'space-between', alignItems: winWidth < 1024 ? 'stretch' : 'center', marginBottom: '24px', gap: '16px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: winWidth < 480 ? 'column' : 'row', gap: '12px', alignItems: 'stretch' }}>
                          ...
                          <div style={{ padding: '8px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                              <div>
                                ...
                                <input type="date" value={fromDate} onChange={(e) => setFromDate(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '10px', border: '1.5px solid #e2e8f0', fontSize: '13px', fontWeight: '700', boxSizing: 'border-box' }} />
                              </div>
                              <div>
                                <label style={{ fontSize: '10px', fontWeight: '900', color: '#94a3b8', display: 'block', marginBottom: '4px' }}>TO DATE</label>
                                <input type="date" value={toDate} onChange={(e) => setToDate(e.target.value)} style={{ width: '100%', padding: '10px', borderRadius: '10px', border: '1.5px solid #e2e8f0', fontSize: '13px', fontWeight: '700', boxSizing: 'border-box' }} />
                              </div>
                            </div>
                  ...
                  >
                    {viewAll ? (winWidth < 480 ? 'Leaders' : 'View Leaders Only') : (winWidth < 480 ? 'Workforce' : 'View All Workforce')}
                  </button>
                </div>
              </div>
