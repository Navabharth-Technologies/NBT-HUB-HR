    ...
    try {
      ...
      try {
        ...
        combinedCerts.forEach(c => {
          ...
          // Merge into assetMap — prefer existing dedicated asset data over cert data for hardware fields
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                  ...
                  <div style={{ background: 'white', border: '1px solid #f1f5f9', borderRadius: '30px', padding: '30px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '25px' }}>
                      ...
                      <h3 style={{ fontSize: '15px', fontWeight: '900', color: '#1e293b', margin: 0 }}>View Assets Submission</h3>
                    </div>
                ...
                <>
                  {(['PENDING', 'PENDING AUDIT'].includes(editModal.certificateData?.status?.toUpperCase())) ? (
                    ...
                    <button
                      disabled={true}
                      style={{
                        flex: 1, padding: '16px', borderRadius: winWidth < 600 ? '14px' : '22px', border: 'none',
                        background: '#cbd5e1',
