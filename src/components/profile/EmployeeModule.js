              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: winWidth < 480 ? '12px' : '20px', marginBottom: winWidth < 480 ? '15px' : '30px' }}>
                  ...
                  <div style={{ overflow: 'hidden', flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: winWidth < 480 ? '11px' : '13px', fontWeight: '700', color: 'var(--primary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{emp.role}</div>
                  </div>

                </div>

                <div style={{ display: 'flex', flexDirection: 'column', gap: winWidth < 480 ? '8px' : '12px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: winWidth < 480 ? '12px' : '14px', color: 'var(--text-muted)', overflow: 'hidden' }}>
                    <span style={{ fontSize: winWidth < 480 ? '12px' : '16px', flexShrink: 0 }}>🏢</span> <span style={{ fontWeight: '700', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', minWidth: 0, flex: 1 }}>{emp.team}</span>
                  </div>
